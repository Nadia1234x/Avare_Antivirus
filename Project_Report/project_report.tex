...
\title{Host-Based Intrusion Detection System}								% Title
\author{Nadia Noormohamed}								% Author
\date{\today}											% Date
...
\begin{titlepage}
	\centering
    \vspace*{0.5 cm}
    \includegraphics[scale = 0.1]{UoM.PNG}\\[1.0 cm]	% University Logo
    \textsc{\LARGE University of Manchester}\\[2.0 cm]	% University Name
	\textsc{\Large COMP30040}\\[0.5 cm]				% Course Code
	\textsc{\large Third Year Project}\\[0.5 cm]				% Course Name
